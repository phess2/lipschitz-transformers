...
optimizer_pre_post_lr = [
    ...
    ("muon", False, True,  [0.05])#np.logspace(-2, 0, 6)), 
]
...
d_embeds = [64, 128, 256, 512, 1024, 2048, 4096, 8192]
project = [
    {"default": "none"},
    #{"default": "orthogonal"},
...
beta1 = 0.9
beta2 = 0.95
schedules = ["none", "sqrt"]      # linear, cosine, sqrt, or none
