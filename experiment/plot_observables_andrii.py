...
path = Path(root_path) / "experiment/results/" + "cifar_muon_embed512_lr0.1000_wd0.0000_steps19400_55b583a9aa5a9b80.json"
...
for t in ["mlp_in", "mlp_0", "mlp_out"]:
   plot_observable(t, "losses")
   plot_observable(t, "val_losses")
   plot_observable(t, "accuracies")
   plot_observable(t, "train_accuracies")
